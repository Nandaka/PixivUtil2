...
$.extend(pixiv, {
	setup: function() {
		...
		pixiv.dispatcher
			.connect(/^\/(?:content_upload_fix|event_detail|member_illust(?:_.+)?|bookmark_add|ranking|ranking_log|novel\/bookmark_add|novel\/show|user_event(?:_.+)?)\.php$/, module.tweetButton).and()
