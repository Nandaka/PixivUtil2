...
#         if self.mode == 1:
#             p = open('./test_data/test-image-big-single.html', 'r', encoding="utf-8")
#             page = BeautifulSoup(p.read(), features="html5lib")
#             return page
#         else:
#             # fake the manga page
#             pageNo = url.split("=")[-1]
#             p = open('./test_data/test-image-parsemanga-big-' + pageNo + '.htm', 'r', encoding="utf-8")
#             page = BeautifulSoup(p.read(), features="html5lib")
#             return page
...
class TestPixivArtist(unittest.TestCase):
    ...
    #     p = open('./test_data/test-noimage.htm', 'r', encoding="utf-8")
    #     page = p.read()
    ...
    def testPixivArtistNoMember(self):
        ...
        with open('./test_data/test-nouser.htm', 'r', encoding="utf-8") as p:
            page = p.read()
        with self.assertRaises(PixivException):
            PixivArtist(1, page)
    ...
    #     p = open('./test_data/test-member-suspended.htm', 'r', encoding="utf-8")
    ...
    #        p = open('./test_data/test-member-nologin.htm', 'r', encoding="utf-8")
    #        page = BeautifulSoup(p.read())
    #        with self.assertRaises(PixivException) as ex:
    ...
    #     # print('\nTesting member page')
    #     p = open('./test_data/test-server-error.html', 'r', encoding="utf-8")
    #     page = BeautifulSoup(p.read())
    #     with self.assertRaises(PixivException) as ex:
    ...
    #     # print('\nTesting own page ')
    #     p = open('./test_data/test-member-self.htm', 'r', encoding="utf-8")
    #     page = BeautifulSoup(p.read())
...
class TestPixivImage(unittest.TestCase):
    ...
    #     p = open('./test_data/test-image-manga-69287623.htm', 'r', encoding="utf-8")
    #     page = p.read()
...
#        p = open('./test_data/test-image-parse-image-40273739-ja.html', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
...
#        self.assertEqual(image2.artist.artistToken, 'k2321656')
    ...
    def testPixivImageParseInfoMixed(self):
        with open('./test_data/test-image-info2-67729319.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
...
#        p = open('./test_data/test-image-parse-image-38826533-pixiv-premium.html', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
...
#        self.assertEqual(image2.artist.artistToken, 'hvcv')
    ...
    def testPixivImageNoAvatar(self):
        ...
        with open('./test_data/test-image-noavatar-20496355.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    def testPixivImageParseTags(self):
        with open('./test_data/test-image-parse-tags-11164869.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    def testPixivImageParseNoTags(self):
        with open('./test_data/test-image-no_tags-9175987.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    def testPixivImageRateCount(self):
        with open('./test_data/test-image-rate_count-28865189.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    #     p = open('./test_data/test-image-noimage.htm', 'r', encoding="utf-8")
    #     page = p.read()
    #     with self.assertRaises(PixivException):
    #         PixivImage(123, page)
    ...
    def testPixivImageGenericError(self):
        ...
        with open('./test_data/test-image-error-123.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
        with self.assertRaises(PixivException):
            PixivImage(123, page)
    ...
    def testPixivImageModeManga(self):
        ...
        with open('./test_data/test-image-manga-28820443.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    def testPixivImageParseMangaInfoMixed(self):
        ...
        # Issue #224
        with open('./test_data/test-image-big-manga-mixed-67487303.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
...
#        # print('\nTesting parse Manga Images')
#        p = open('./test_data/test-image-manga-2page.htm', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
#        image = PixivImage()
...
#        p = open('./test_data/test-image-unicode.htm', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
...
#        # print('\nTesting parse Manga Images')
#        p = open('./test_data/test-image-parsemanga.htm', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
#        image = PixivImage()
...
#        # print('\nTesting parse Manga Images')
#        # Issue #224
#        p = open('./test_data/test-image-big-manga.html', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
...
#        self.assertEqual(int(imageId), 62670665)
    ...
    def testPixivImageNoLogin(self):
        ...
        with open('./test_data/test-image-nologin-67089412.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
        try:
    ...
    def testPixivImageUgoira(self):
        # print('\nTesting image page')
        with open('./test_data/test-image-ugoira-46281014.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
    ...
    def testPixivImageParseInfoSelf(self):
        ...
        with open('./test_data/test-image-selfimage-65079382.json', 'r', encoding="utf-8") as p:
            page = p.read()
        PixivBrowser.getMemberInfoWhitecube = mock_getMemberInfoWhitecube
...
class TestPixivBookmark(unittest.TestCase):
    def testPixivBookmarkNewIlust(self):
        ...
        with open('./test_data/test-bookmarks_new_ilust.json', 'r', encoding="utf-8") as p:
            # page = BeautifulSoup(p.read(), features="html5lib")
            page = p.read()
    ...
    def testPixivImageBookmark(self):
        ...
        with open('./test_data/bookmarks.json', 'r', encoding="utf-8") as p:
            page = p.read()
...
#        # print('\nTesting PixivImageBookmark')
#        p = open('./test_data/test-image-bookmark-member.htm', 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
...
#         try:
#             path = './test_data/test-image-my_pick.html'
...
#             self.assertEqual(ex.errorCode, 2004)
    ...
    #     try:
    #         path = './test_data/test-image-guro-e.html'
    #         p = open(path, 'r', encoding="utf-8")
    #         page = BeautifulSoup(p.read())
    ...
    #     try:
    #         path = './test_data/test-image-ero-e.html'
    #         p = open(path, 'r', encoding="utf-8")
    #         page = BeautifulSoup(p.read())
...
class TestPixivTags(unittest.TestCase):
    def testTagsSearchExact1(self):
        path = './test_data/test-tags-search-exact2.htm'
    ...
    def testTagsSearchExact(self):
        path = './test_data/test-tags-search-exact.htm'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = ''
        current_page = 1
    ...
    def testTagsSearchExactLast(self):
        path = './test_data/test-tags-search-exact-last.json'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = ''
    ...
    def testTagsSearchPartialNotLast(self):
        path = './test_data/tag-not-last-page.json'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = ''
    ...
    def testTagsSearchPartial(self):
        path = './test_data/test-tags-search-partial.htm'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
    ...
    def testTagsSearchPartialLast(self):
        path = './test_data/test-tags-search-partial-last.htm'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = '%E3%81%93%E3%81%AE%E4%B8%AD%E3%81%AB1%E4%BA%BA%E3%80%81%E5%A6%B9%E3%81%8C%E3%81%84%E3%82%8B!'
        current_page = 4
    ...
    def testTagsSearchParseDetails(self):
        path = './test_data/test-tags-search-exact-parse_details.htm'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = ''
        current_page = 1
...
#        path = './test_data/test-tags-member-search.htm'
#        p = open(path, 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
#        image = PixivTags()
...
#        path = './test_data/test-tags-member-search-last.htm'
#        p = open(path, 'r', encoding="utf-8")
#        page = BeautifulSoup(p.read())
#        image = PixivTags()
#        image.parseMemberTags(page, 313631)
...
#        self.assertEqual(image.isLastPage, True)
    ...
    def testTagsSkipShowcase(self):
        path = './test_data/test-tags-search-skip-showcase.htm'
        with open(path, 'r', encoding="utf-8") as p:
            response = p.read()
        tags = 'K-On!'
        current_page = 1
