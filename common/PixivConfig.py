...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("FFmpeg", "ffmpegParam", "-lossless 0 -crf 15 -b 0 -fps_mode passthrough -pix_fmt yuv420p"),
        ConfigItem("FFmpeg", "mkvCodec", "copy"),
        ConfigItem("FFmpeg", "mkvParam", ""),
        ConfigItem("FFmpeg", "webpCodec", "libwebp"),
        ConfigItem("FFmpeg", "webpParam", "-lossless 0 -compression_level 5 -quality 100 -loop 0 -fps_mode passthrough"),
        ConfigItem("FFmpeg", "gifParam",
                   "-filter_complex [0:v]split[a][b];[a]palettegen=stats_mode=diff[p];[b][p]paletteuse=dither=bayer:bayer_scale=5:diff_mode=rectangle -fps_mode passthrough"),
        ConfigItem("FFmpeg", "apngParam", "-plays 0 -fps_mode passthrough"),
        ConfigItem("FFmpeg", "avifCodec", "libaom-av1"),
        ConfigItem("FFmpeg", "avifParam", "-cpu-used 4 -crf 0 -row-mt 1 -tile-columns 2 -tile-rows 2 -fps_mode passthrough"),
