...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("Settings", "writeMemberJSON", False),
        ...
        ConfigItem("Filename", "filenameSeriesJSON",
                   ...
                   restriction=lambda x: x is not None and len(x) > 0),
        ConfigItem("Filename", "filenameMemberJSON", "%artist% (%member_id%)" + os.sep + "Artist %member_id% (%artist%)",
                   restriction=lambda x: x is not None and len(x) > 0),
        ...
        ConfigItem("DownloadControl", "preprocess", 0),
        ...
        ConfigItem("DownloadControl", "extension_filter", "")
    ]
