...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("FFmpeg", "gifParam",
                   "-filter_complex [0:v]scale,split[a][b];[a]palettegen=stats_mode=diff[p];[b][p]paletteuse=dither=bayer:bayer_scale=5:diff_mode=rectangle"),
        ConfigItem("FFmpeg", "apngParam", "-vf scale,setpts=PTS-STARTPTS,hqdn3d=1.5:1.5:6:6 -plays 0"),
