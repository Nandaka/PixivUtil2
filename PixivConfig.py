...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("Settings", "downloadListDirectory", "./downloads", followup=os.path.expanduser),
        ConfigItem("Settings", "useList", False),
        ConfigItem("Settings", "processFromDb", True),
        ConfigItem("Settings", "rootDirectory", "./downloads"),
        ...
        ConfigItem("Settings", "dbPath", "./.pixivUtil2/db/db.sqlite"),
        ...
        ConfigItem("Filename", "filenameSeriesJSON",
                   "%artist% (%member_id%)/%manga_series_id% - %manga_series_title%",
                   restriction=stringNotEmpty),
        ConfigItem("Filename", "filenameFormatSketch", "%artist% (%member_id%)/%urlFilename% - %title%",
                   restriction=stringNotEmpty),
        ConfigItem("Filename", "filenameFormatNovel",
                   "%artist% (%member_id%)/%manga_series_id% %manga_series_order% %urlFilename% - %title%",
                   restriction=stringNotEmpty),
