...
class PixivConfig():
    ...
    __items = [
        ...
        ConfigItem("FFmpeg", "ffmpegParam", "-lossless 0 -crf 15 -b 0 -vsync 2"),
        ConfigItem("FFmpeg", "webpCodec", "libwebp"),
        ConfigItem("FFmpeg", "webpParam", "-lossless 0 -compression_level 5 -quality 100 -loop 0 -vsync 2"),
        ...
        ConfigItem("FFmpeg", "apngParam", "-plays 0"),
